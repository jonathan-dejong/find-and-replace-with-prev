...
class FindView {
      ...
      $.div({tabIndex: -1, className: 'find-and-replace'},
        ...
        $.section({className: 'input-block replace-container'},
          ...
          $.div({className: 'input-block-item'},
			...
			$.div({className: 'btn-group btn-group-replace'},
              $.button({ref: 'replacePreviousButton', className: 'btn btn-previous'}, 'Replace prev')
            ),
  ...
  handleReplaceEvents() {
	...
	this.refs.replacePreviousButton.addEventListener('click', this.replacePrevious.bind(this));
  ...
  updateReplaceEnablement() {
    ...
    if (canReplace) {
	  ...
	  this.refs.replacePreviousButton.classList.remove('disabled');
	  ...
	  this.replaceTooltipSubscriptions.add(atom.tooltips.add(this.refs.replacePreviousButton, {
        title: "Replace Previous",
        keyBindingCommand: 'find-and-replace:replace-previous',
        keyBindingTarget: this.replaceEditor.element
      }));
	  ...
	  this.refs.replacePreviousButton.classList.add('disabled');
